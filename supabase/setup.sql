...
create policy "vendor_profile_showcase_images_select_owner" on public.vendor_profile_showcase_images for select
  using (auth.uid()::text = user_id);
drop policy if exists "vendor_profile_showcase_images_insert_blocked" on public.vendor_profile_showcase_images;
create policy "vendor_profile_showcase_images_insert_blocked" on public.vendor_profile_showcase_images for insert with check (false);
drop policy if exists "vendor_profile_showcase_images_update_blocked" on public.vendor_profile_showcase_images;
create policy "vendor_profile_showcase_images_update_blocked" on public.vendor_profile_showcase_images for update using (false);
drop policy if exists "vendor_profile_showcase_images_delete_blocked" on public.vendor_profile_showcase_images;
create policy "vendor_profile_showcase_images_delete_blocked" on public.vendor_profile_showcase_images for delete using (false);
...
create policy "vendor_showcase_select_public" on storage.objects for select using (bucket_id = 'vendor-showcase');
drop policy if exists "vendor_showcase_insert_blocked" on storage.objects;
create policy "vendor_showcase_insert_blocked" on storage.objects for insert with check (false);
drop policy if exists "vendor_showcase_delete_blocked" on storage.objects;
create policy "vendor_showcase_delete_blocked" on storage.objects for delete using (false);
